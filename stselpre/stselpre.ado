*! version 1.1.0  27aug2000            (STB-59: sbe41)
...
*!         noHR Level(integer $S_level) noSHow BRESlow EFRon EXACTM EXACTP ]
*  Enzo Coviello (coviello@mythnet.it)
	...
	st_is 2 analysis
        ...
        syntax varlist(min=1) [if] [in] [, /*
        */ noHR Level(integer $S_level) noSHow /*
        */ BRESlow EFRon EXACTM EXACTP SELF ]
	...
	st_show `show'
        ...
        qui {
              ...
              if `n' - _N < `subev' { 
                      di in re _n "Data were corrupted from previous stcascoh" _n
                      error 459
              }
              stcox `varlist', `ties' 
              local N_Pre = e(N)
